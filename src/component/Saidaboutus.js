import Happycustomerpic1 from '../images/happycustomer1.png'
import Happycustomerpic2 from '../images/happycustomer2.png'
import Happycustomerpic3 from '../images/happycustomer3.png'
import Happycustomerpic4 from '../images/happycustomer4.png'
import Happycustomerpic5 from '../images/happycustomer5.png'
                        ...
                        <div className="carousel-item">
                            ...
                            <div className='row'>
                                ...
                                <div className="col">
                                    <div className="card">
                                        <div className="card-header">
                                            <img src={Happycustomerpic5} className="card-img-top" alt="..." />
